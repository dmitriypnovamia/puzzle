...
class NumbersMatchStageViewController: BaseSwiftViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell{
        ...
        case 0:
            ...
            cell.imgView?.image = UIImage(named: "1_arrango")

        case 1:
            cell.subPackNameLbl?.text = "Playing Kid Mode"
            //cell.descriptionLbl?.text = "4X4"
            cell.imgView?.image = UIImage(named: "2_arrango")
            cell.buyBtn?.setTitle("Play", for: .normal)
            cell.buyBtn?.addTarget(self, action: #selector(play(btn:)), for: .touchUpInside)
        case 2:
            cell.subPackNameLbl?.text = "Smarty Boy Mode"
            cell.imgView?.image = UIImage(named: "3_arrango")
            cell.buyBtn?.setTitle("Play", for: .normal)
            cell.buyBtn?.addTarget(self, action: #selector(play(btn:)), for: .touchUpInside)
        case 3:
            cell.subPackNameLbl?.text = "Bachelor Mode"
            cell.imgView?.image = UIImage(named: "4_arrango")
            cell.buyBtn?.setTitle("Play", for: .normal)
            cell.buyBtn?.addTarget(self, action: #selector(play(btn:)), for: .touchUpInside)
        case 4:
            cell.subPackNameLbl?.text = "Dad Mode"
            cell.imgView?.image = UIImage(named: "5_arrango")
            cell.buyBtn?.setTitle("Play", for: .normal)
            cell.buyBtn?.addTarget(self, action: #selector(play(btn:)), for: .touchUpInside)
        case 5:
            cell.subPackNameLbl?.text = "Grand Father Mode"
            cell.imgView?.image = UIImage(named: "6_arrango")
            cell.buyBtn?.setTitle("Play", for: .normal)
            cell.buyBtn?.addTarget(self, action: #selector(play(btn:)), for: .touchUpInside)
        default:
            cell.subPackNameLbl?.text = "New Born Mode"
    ...
    func goToGameView(index: Int)  {
        if let levelSelectViewController = self.storyboard?.instantiateViewController(withIdentifier: "NumbersMatchLevelSelectViewController") as? NumbersMatchLevelSelectViewController{
            switch index{
            case 0:
                levelSelectViewController.stageType = "arrangeNumbers_New_Born"
                levelSelectViewController.readAbleStage = "New Born"
            case 1:
                levelSelectViewController.stageType = "arrangeNumbers_Playing_Kid"
                levelSelectViewController.readAbleStage = "Playing Kid"
            case 2:
                levelSelectViewController.stageType = "arrangeNumbers_Smarty_Boy"
                levelSelectViewController.readAbleStage = "Smarty Boy"
            case 3:
                levelSelectViewController.stageType = "arrangeNumbers_Bachelor"
                levelSelectViewController.readAbleStage = "Bachelor"
            case 4:
                levelSelectViewController.stageType = "arrangeNumbers_Dad"
                levelSelectViewController.readAbleStage = "Dad"
            case 5:
                levelSelectViewController.stageType = "arrangeNumbers_Grand_Father"
