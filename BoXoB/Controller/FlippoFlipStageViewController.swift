...
class FlippoFlipStageViewController: BaseSwiftViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let levelNumber =  UserDefaults.standard.integer(forKey: "flippoflip_levelNumber")
        let isVIP =  UserDefaults.standard.bool(forKey: "isVIP")
        switch indexPath.row {
        case 0:
    ...
    func goToGameView(index: Int)  {
        if let levelSelectViewController = self.storyboard?.instantiateViewController(withIdentifier: "FlippoFlipLevelSelectViewController") as? FlippoFlipLevelSelectViewController{
            switch index{
            case 0:
                levelSelectViewController.stageType = "flippoflip_New_Born"
                levelSelectViewController.readAbleStage = "New Born"
            case 1:
                levelSelectViewController.stageType = "flippoflip_Playing_Kid"
                levelSelectViewController.readAbleStage = "Playing Kid"

            case 2:
                levelSelectViewController.stageType = "flippoflip_Smarty_Boy"
                levelSelectViewController.readAbleStage = "Smarty Boy"

            case 3:
                levelSelectViewController.stageType = "flippoflip_Bachelor"
                levelSelectViewController.readAbleStage = "Bachelor"

            case 4:
                levelSelectViewController.stageType = "flippoflip_Dad"
                levelSelectViewController.readAbleStage = "Dad"

            case 5:
                levelSelectViewController.stageType = "flippoflip_Grand_Father"
