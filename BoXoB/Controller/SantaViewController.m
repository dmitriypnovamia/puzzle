...
-(void)beginGame{
    ...
    if (self.dailyPuzzle == true){
        ...
        self.levelNumberLbl.text      =   @"Santa Puzzle";
        ...
        NSUInteger customLevelNumber = self.levelNumber + 150;
        
        self.levelNumberLbl.text    =   [NSString stringWithFormat:@"Level: %lu",(unsigned long)self.levelNumber];
        self.puzzleImage = [UIImage imageNamed:[NSString stringWithFormat:@"%lu",(unsigned long)customLevelNumber]];
        ...
        if (self.puzzleImage == nil){
            ...
            if (self.puzzleImage == nil){
                ...
                [appDelegate downloadImageWithLevelNumber:customLevelNumber success:^(UIImage * _Nonnull image) {
...
//        }
        ...
        if (self.dailyPuzzle == false || self.cameraPicPuzzle == false){
            ...
            NSUInteger overAllLevelNumber  =   [[NSUserDefaults standardUserDefaults] integerForKey:@"santa_levelNumber"];
            
            if (self.levelNumber > levelNumberForStage){
                [[NSUserDefaults standardUserDefaults] setInteger:overAllLevelNumber + 1 forKey:@"santa_levelNumber"];
