...
class SantaStageViewController: BaseSwiftViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    func goToGameView(index: Int) {
        if let levelSelectViewController = self.storyboard?.instantiateViewController(withIdentifier: "SantaLevelSelectViewController") as? SantaLevelSelectViewController{
            switch index{
            case 0:
                levelSelectViewController.stageType = "Santa_New_Born"
                levelSelectViewController.readAbleStage = "New Born"
            case 1:
                levelSelectViewController.stageType = "Santa_Playing_Kid"
                levelSelectViewController.readAbleStage = "Playing Kid"
            case 2:
                levelSelectViewController.stageType = "Santa_Smarty_Boy"
                levelSelectViewController.readAbleStage = "Smarty Boy"
            case 3:
                levelSelectViewController.stageType = "Santa_Bachelor"
                levelSelectViewController.readAbleStage = "Bachelor"
            case 4:
                levelSelectViewController.stageType = "Santa_Dad"
                levelSelectViewController.readAbleStage = "Dad"
            case 5:
                levelSelectViewController.stageType = "Santa_Grand_Father"
