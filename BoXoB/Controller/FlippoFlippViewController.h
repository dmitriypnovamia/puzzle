...
@interface FlippoFlippViewController : BaseViewController
{
    CGFloat tileWidth;
    CGFloat tileHeight;
    NSArray *products;
...
@property (weak, nonatomic) IBOutlet UIView *buttonStack;
...
@property (weak, nonatomic) IBOutlet UIButton *flipHBtn;
@property (weak, nonatomic) IBOutlet UIButton *flipVBtn;
