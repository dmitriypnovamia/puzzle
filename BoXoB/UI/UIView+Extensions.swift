...
public extension UIView {
    ...
    func style() {
        ...
        self.shadowPath = UIBezierPath(roundedRect: self.bounds, byRoundingCorners: .allCorners, cornerRadii: CGSize(width: 5, height: 5)).cgPath
        self.shadowShouldRasterize = true
        self.shadowRasterizationScale = UIScreen.main.scale
    }
